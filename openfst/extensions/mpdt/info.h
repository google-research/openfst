...
#ifndef OPENFST_EXTENSIONS_MPDT_INFO_H_
#define OPENFST_EXTENSIONS_MPDT_INFO_H_
...
MPdtInfo<Arc, nlevels>::MPdtInfo(
  ...
  absl::flat_hash_map<Label, int> paren_levels;
...
#endif  // OPENFST_EXTENSIONS_MPDT_INFO_H_
