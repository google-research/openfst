...
#ifndef OPENFST_EXTENSIONS_NGRAM_BITMAP_INDEX_H_
#define OPENFST_EXTENSIONS_NGRAM_BITMAP_INDEX_H_
...
class BitmapIndex {
 ...
 private:
  ...
  // TODO: benchmark different values here.
  ...
  // to measure. TODO: Try to measure with low bit density.
  ...
  class RankIndexEntry {
   public:
    ...
    uint32_t relative_ones_count(size_t k) const {
      ABSL_ASSUME(k < 8);
      // TODO: Try a multiply here instead.
...
#endif  // OPENFST_EXTENSIONS_NGRAM_BITMAP_INDEX_H_
