...
#ifndef OPENFST_EXTENSIONS_NGRAM_NGRAM_FST_H_
#define OPENFST_EXTENSIONS_NGRAM_NGRAM_FST_H_
...
class NGramFstImpl : public FstImpl<A> {
 ...
 private:
  ...
  // states, but it's also small. TODO: Look at EliasFanoArray.
...
NGramFstImpl<A>::NGramFstImpl(const Fst<A>& fst,
  ...
  memcpy(data + offset, reinterpret_cast<char*>(&num_final), sizeof(num_final));
...
// for sample usage. This version should inline.
template <class A>
...
#endif  // OPENFST_EXTENSIONS_NGRAM_NGRAM_FST_H_
