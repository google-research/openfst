...
#ifndef OPENFST_EXTENSIONS_SPECIAL_RHO_FST_H_
#define OPENFST_EXTENSIONS_SPECIAL_RHO_FST_H_
...
ABSL_DECLARE_FLAG(int64_t, rho_fst_rho_label);
ABSL_DECLARE_FLAG(std::string, rho_fst_rewrite_mode);
...
class RhoFstMatcherData {
 public:
  explicit RhoFstMatcherData(
      Label rho_label = absl::GetFlag(FLAGS_rho_fst_rho_label),
      MatcherRewriteMode rewrite_mode =
          RewriteMode(absl::GetFlag(FLAGS_rho_fst_rewrite_mode)))
...
#endif  // OPENFST_EXTENSIONS_SPECIAL_RHO_FST_H_
