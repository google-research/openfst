...
#ifndef OPENFST_EXTENSIONS_SPECIAL_SIGMA_FST_H_
#define OPENFST_EXTENSIONS_SPECIAL_SIGMA_FST_H_
...
ABSL_DECLARE_FLAG(int64_t, sigma_fst_sigma_label);
ABSL_DECLARE_FLAG(std::string, sigma_fst_rewrite_mode);
...
class SigmaFstMatcherData {
 public:
  explicit SigmaFstMatcherData(
      Label sigma_label = absl::GetFlag(FLAGS_sigma_fst_sigma_label),
      MatcherRewriteMode rewrite_mode =
          RewriteMode(absl::GetFlag(FLAGS_sigma_fst_rewrite_mode)))
...
#endif  // OPENFST_EXTENSIONS_SPECIAL_SIGMA_FST_H_
