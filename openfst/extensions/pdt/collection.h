...
#ifndef OPENFST_EXTENSIONS_PDT_COLLECTION_H_
#define OPENFST_EXTENSIONS_PDT_COLLECTION_H_
 ...
 public:
  ...
  struct NodeHash {
    size_t operator()(const Node& n) const {
      return absl::HashOf(n.node_id, n.element);
    }
  };
...
#endif  // OPENFST_EXTENSIONS_PDT_COLLECTION_H_
