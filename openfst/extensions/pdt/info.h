...
#ifndef OPENFST_EXTENSIONS_PDT_INFO_H_
#define OPENFST_EXTENSIONS_PDT_INFO_H_
...
class PdtInfo {
 public:
  ...
  PdtInfo(const Fst<Arc>& fst,
          absl::Span<const std::pair<Label, Label>> parents);
...
PdtInfo<Arc>::PdtInfo(
  ...
  absl::flat_hash_map<Label, size_t> paren_map;
  absl::flat_hash_set<Label> paren_set;
  absl::flat_hash_set<StateId> open_paren_state_set;
  absl::flat_hash_set<StateId> close_paren_state_set;
...
#endif  // OPENFST_EXTENSIONS_PDT_INFO_H_
