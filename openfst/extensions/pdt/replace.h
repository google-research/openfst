...
#ifndef OPENFST_EXTENSIONS_PDT_REPLACE_H_
#define OPENFST_EXTENSIONS_PDT_REPLACE_H_
...
class PdtParser {
 public:
  ...
  using ParenMap = absl::flat_hash_map<ParenKey, size_t,
                                       internal::ReplaceParenHash<StateId>>;

  PdtParser(absl::Span<const LabelFstPair> fst_array,
 ...
 protected:
  ...
  void AddParensToSymbolTables(absl::Span<const LabelPair> parens,
                               MutableFst<Arc>* ofst);
 ...
 private:
  ...
  absl::flat_hash_map<Label, StateId> label2id_;
...
template <class Arc>
void PdtParser<Arc>::AddParensToSymbolTables(absl::Span<const LabelPair> parens,
                                             MutableFst<Arc>* ofst) {
...
#endif  // OPENFST_EXTENSIONS_PDT_REPLACE_H_
