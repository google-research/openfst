...
#ifndef OPENFST_EXTENSIONS_PDT_PDT_H_
#define OPENFST_EXTENSIONS_PDT_PDT_H_
...
class PdtStack {
 ...
 private:
  ...
  absl::flat_hash_map<Label, size_t> paren_map_;
  // Child of stack node w.r.t label
  absl::flat_hash_map<std::pair<StackId, Label>, StackId, ChildHash> child_map_;
  Label min_paren_;
  Label max_paren_;
};
...
#endif  // OPENFST_EXTENSIONS_PDT_PDT_H_
