...
#ifndef OPENFST_EXTENSIONS_FAR_INFO_H_
#define OPENFST_EXTENSIONS_FAR_INFO_H_
...
template <class Arc>
void GetInfo(absl::Span<const std::string> sources, absl::string_view begin_key,
             absl::string_view end_key, const bool list_fsts,
...
template <class Arc>
void Info(absl::Span<const std::string> sources, absl::string_view begin_key,
          absl::string_view end_key, const bool list_fsts) {
  FarInfoData info;
...
#endif  // OPENFST_EXTENSIONS_FAR_INFO_H_
