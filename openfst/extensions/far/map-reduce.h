...
#ifndef OPENFST_EXTENSIONS_FAR_MAP_REDUCE_H_
#define OPENFST_EXTENSIONS_FAR_MAP_REDUCE_H_
...
// interface:
//
// std::unique_ptr<Fst<Arc>> operator()(absl::string_view key,
//                                      const Fst<Arc> *fst);
//
...
//
// bool operator()(absl::string_view key, const Fst<Arc> *fst1,
//                 const Fst<Arc> *fst2);
//
...
bool MapAllReduce(FarReader<Arc>& reader1, FarReader<Arc>& reader2,
                  Functor functor, absl::string_view begin_key = "",
...
#endif  // OPENFST_EXTENSIONS_FAR_MAP_REDUCE_H_
