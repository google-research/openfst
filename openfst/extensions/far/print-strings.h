...
#ifndef OPENFST_EXTENSIONS_FAR_PRINT_STRINGS_H_
#define OPENFST_EXTENSIONS_FAR_PRINT_STRINGS_H_
...
ABSL_DECLARE_FLAG(std::string, far_field_separator);
...
#endif  // OPENFST_EXTENSIONS_FAR_PRINT_STRINGS_H_
