...
int KeySize(absl::string_view source);

}  // namespace internal

template <class Arc>
void CompileStrings(absl::Span<const std::string> sources,
                    FarWriter<Arc>& writer, absl::string_view fst_type,
...
#endif  // OPENFST_EXTENSIONS_FAR_COMPILE_STRINGS_H_
