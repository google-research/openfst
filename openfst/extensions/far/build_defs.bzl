...
def convert_far_types(
    ...
    Args:
      ...
      far_binary_rule: Allows specifying a custom far cc_binary target to perform the conversion.
                       ...
                       binary target ("//openfst/static:far").
    ...
    farconvert_rule = far_binary_rule or "//openfst/static:far"
    farconvert_cmd = "$(location %s) convert " % farconvert_rule
...
def extract_fsts_from_far(name, far, fsts, far_binary_rule = None, **kwds):
    ...
    farextract_rule = far_binary_rule or "//openfst/static:far"
    fst_extension = ".fst"
