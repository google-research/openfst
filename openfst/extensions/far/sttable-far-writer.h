...
//
// STTableFarWriter class.

#ifndef OPENFST_EXTENSIONS_FAR_STTABLE_FAR_WRITER_H_
#define OPENFST_EXTENSIONS_FAR_STTABLE_FAR_WRITER_H_
...
#endif  // OPENFST_EXTENSIONS_FAR_STTABLE_FAR_WRITER_H_
