...
#ifndef OPENFST_EXTENSIONS_LINEAR_LINEAR_FST_DATA_BUILDER_H_
#define OPENFST_EXTENSIONS_LINEAR_LINEAR_FST_DATA_BUILDER_H_
...
class LinearFstDataBuilder {
 public:
  ...
  // are non-positive.
  bool AddWord(Label word, absl::Span<const Label> features);
...
class FeatureGroupBuilder {
 public:
  ...
  //
  // TODO: check overlapping top-level contexts (see
...
bool LinearFstDataBuilder<A>::AddWord(Label word,
                                      absl::Span<const Label> features) {
  if (error_) {
...
#endif  // OPENFST_EXTENSIONS_LINEAR_LINEAR_FST_DATA_BUILDER_H_
