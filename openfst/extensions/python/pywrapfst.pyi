...
_WeightType = str
_WeightStr = str | int | float
WeightLike = Weight | _WeightStr
...
# TODO: Look into converting these to operator overloading instead.
...
class SymbolTableView:
  ...
  def member(self, key: _Symbol | _Label) -> bool: ...
  def name(self) -> str: ...
...
class EncodeMapper:
  ...
  def set_input_symbols(
      self, syms: SymbolTableView | None
  ) -> EncodeMapper: ...
...
class Fst:
  ...
  def draw(
      self,
      source: _Filename,
      isymbols: SymbolTableView | None = ...,
      osymbols: SymbolTableView | None = ...,
      ssymbols: SymbolTableView | None = ...,
      acceptor: bool = ...,
      title: str = ...,
      width: float = ...,
      height: float = ...,
...
class MutableFst(Fst):
  ...
  def delete_states(
      self: T, states: Iterable[_StateId] | None = ...
  ) -> T: ...
  ...
  def relabel_pairs(
      self: T,
      ipairs: Iterable[tuple[_Label, _Label]] | None = ...,
      opairs: Iterable[tuple[_Label, _Label]] | None = ...,
  ) -> T: ...
  def relabel_tables(
      self: T,
      old_isymbols: SymbolTableView | None = ...,
      new_isymbols: SymbolTableView | None = ...,
      unknown_isymbol: _Symbol = ...,
      attach_new_isymbols: bool = ...,
      old_osymbols: SymbolTableView | None = ...,
      new_osymbols: SymbolTableView | None = ...,
  ...
  def set_final(
      self: T, state: _StateId, weight: WeightLike | None = ...
  ) -> T: ...
  def set_input_symbols(self: T, syms: SymbolTableView | None) -> T: ...
  def set_output_symbols(self: T, syms: SymbolTableView | None) -> T: ...
  def set_properties(
...
class _ArcIterator:
  def __repr__(self) -> str: ...
  # TODO: Consider making this `FstLike` instead.
...
class Compiler:
  ...
  def __init__(
      ...
      arc_type: _ArcTypeFlag = ...,
      # TODO: Look into converting these to SymbolTableView.
      isymbols: SymbolTable | None = ...,
      osymbols: SymbolTable | None = ...,
      ssymbols: SymbolTable | None = ...,
      acceptor: bool = ...,
      keep_isymbols: bool = ...,
      keep_osymbols: bool = ...,
