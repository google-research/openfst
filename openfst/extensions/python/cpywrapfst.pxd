...
cdef extern from "absl/flags/flag.h" namespace "absl" nogil:
  ...
  cdef cppclass Flag[T]:
    pass

  # Only import specialization for boolean flags since this is what we care
  # about below.
  void SetFlag(Flag[bool] *, bool)


cdef extern from "openfst/lib/util.h" nogil:

  Flag[bool] FLAGS_fst_error_fatal


cdef extern from "openfst/lib/fstlib.h" namespace "fst" nogil:
  ...
  # TODO: Don't do this hack if Cython gets proper enum class
...
cdef extern from "openfst/script/fstscript.h" namespace "fst::script" \
    nogil:
...
cdef extern from "openfst/extensions/far/far.h" namespace "fst" nogil:
...
cdef extern from "openfst/extensions/far/getters.h" \
    namespace "fst" nogil:
...
cdef extern from "openfst/extensions/far/far-class.h" \
    namespace "fst::script" nogil:
