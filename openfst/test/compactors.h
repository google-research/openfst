...
#ifndef OPENFST_TEST_COMPACTORS_H_
#define OPENFST_TEST_COMPACTORS_H_
...
class TrivialCompactor {
 public:
  ...
  static TrivialCompactor* Read(std::istream& strm, FstReadOptions opts,
    ...
    opts.header = nullptr;
    auto fst = absl::WrapUnique(VectorFst<Arc>::Read(strm, opts));
...
#endif  // OPENFST_TEST_COMPACTORS_H_
