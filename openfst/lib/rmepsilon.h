...
#ifndef OPENFST_LIB_RMEPSILON_H_
#define OPENFST_LIB_RMEPSILON_H_
  ...
  struct ElementHash {
   public:
    size_t operator()(const Element& element) const {
      return absl::HashOf(element.nextstate, element.ilabel, element.olabel);
    }
  };
...
#endif  // OPENFST_LIB_RMEPSILON_H_
