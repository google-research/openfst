...
#ifndef OPENFST_LIB_COMPACT_FST_H_
#define OPENFST_LIB_COMPACT_FST_H_
...
class CompactArcCompactor {
 public:
  ...
  // TODO: remove dependencies on this method and make private.
...
class CompactFstImpl
 ...
 public:
  ...
  void SetCompactor(std::shared_ptr<Compactor> compactor) {
    // TODO: is this correct? is this needed?
    // TODO: consider removing and forcing this through direct calls
    // to compactor.
...
class CompactFst
 ...
 public:
  ...
  static CompactFst* Read(absl::string_view source) {
...
bool WriteCompactArcFst(
  ...
  if (const Compactor* const compactor =
    ...
    // TODO: eliminate mutable state from compactors.
    num_arcs = 0;
    num_states = 0;
...
#endif  // OPENFST_LIB_COMPACT_FST_H_
