...
#ifndef OPENFST_LIB_RELABEL_H_
#define OPENFST_LIB_RELABEL_H_
...
void Relabel(MutableFst<Arc>* fst, const SymbolTable* old_isymbols,
             const SymbolTable* new_isymbols, absl::string_view unknown_isymbol,
             bool attach_new_isymbols, const SymbolTable* old_osymbols,
             const SymbolTable* new_osymbols, absl::string_view unknown_osymbol,
