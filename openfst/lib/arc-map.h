...
#ifndef OPENFST_LIB_ARC_MAP_H_
#define OPENFST_LIB_ARC_MAP_H_
...
// be an `ExpandedFst`.
// TODO: Support kExpanded propagation for other values of
// `FinalAction()`.
template <typename C>
...
// TODO: Add common base class for those mappers which do nothing except
