...
#ifndef OPENFST_LIB_CACHE_H_
#define OPENFST_LIB_CACHE_H_
...
ABSL_DECLARE_FLAG(bool, fst_default_cache_gc);
ABSL_DECLARE_FLAG(int64_t, fst_default_cache_gc_limit);
...
struct CacheOptions {
  ...
  explicit CacheOptions(
      bool gc = absl::GetFlag(FLAGS_fst_default_cache_gc),
      size_t gc_limit = absl::GetFlag(FLAGS_fst_default_cache_gc_limit))
