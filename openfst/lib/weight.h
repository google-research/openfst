...
#ifndef OPENFST_LIB_WEIGHT_H_
#define OPENFST_LIB_WEIGHT_H_
...
ABSL_DECLARE_FLAG(std::string, fst_weight_parentheses);
ABSL_DECLARE_FLAG(std::string, fst_weight_separator);
