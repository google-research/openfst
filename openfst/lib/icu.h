...
bool ByteStringToLabels(absl::string_view str, std::vector<Label>* labels) {
...
// Labels (e.g., 64 bits).
template <class Label>
bool UTF8StringToLabels(absl::string_view str, std::vector<Label>* labels) {
