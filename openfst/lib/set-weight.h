...
#ifndef OPENFST_LIB_SET_WEIGHT_H_
#define OPENFST_LIB_SET_WEIGHT_H_
...
inline std::istream& operator>>(std::istream& strm,
  ...
  if (str == "EmptySet") {
    ...
    weight.Clear();
    for (absl::string_view sv : absl::StrSplit(str, kSetSeparator)) {
...
#endif  // OPENFST_LIB_SET_WEIGHT_H_
