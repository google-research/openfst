...
#ifndef OPENFST_LIB_REPLACE_H_
#define OPENFST_LIB_REPLACE_H_
...
class ReplaceFstImpl
 ...
 public:
  ...
  bool IsNonTerminal(Label label) const {
    ...
    // TODO: be smarter and take advantage of all_dense or
  ...
  void InitArcIterator(StateId s, ArcIteratorData<Arc>* data) {
    ...
    // TODO: Set behaviour of generic iterator.
