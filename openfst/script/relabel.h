...
#ifndef OPENFST_SCRIPT_RELABEL_H_
#define OPENFST_SCRIPT_RELABEL_H_
...
using FstRelabelArgs1 =
    std::tuple<MutableFstClass*, const SymbolTable*, const SymbolTable*,
               const std::string&, bool, const SymbolTable*, const SymbolTable*,
...
using FstRelabelArgs2 =
    std::tuple<MutableFstClass*, absl::Span<const std::pair<int64_t, int64_t>>,
...
#endif  // OPENFST_SCRIPT_RELABEL_H_
