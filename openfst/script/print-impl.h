...
#ifndef OPENFST_SCRIPT_PRINT_IMPL_H_
...
class FstPrinter {
 public:
  ...
  explicit FstPrinter(const Fst<Arc>& fst, const SymbolTable* isyms,
                      ...
                      absl::string_view field_separator,
                      absl::string_view missing_symbol = "")
      : fst_(fst),
        isyms_(isyms),
        osyms_(osyms),
        ssyms_(ssyms),
  ...
  void Print(std::ostream& ostrm, absl::string_view dest) {
...
#endif  // OPENFST_SCRIPT_PRINT_IMPL_H_
